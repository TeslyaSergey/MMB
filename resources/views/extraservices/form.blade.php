			...
			<div class="col-md-12">
				...
				{!! Form::hidden('extraserviceID', $row['extraserviceID']) !!}
									  <div class="form-group  " >
										<label for="Service Name" class=" control-label col-md-3 text-left"> {{ Lang::get('core.extraservice') }} <span class="asterix"> * </span></label>
										<div class="col-md-8">
						...
						required     class='form-control ' />
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-3">
										  <input  type='text' name='price' id='price' value='{{ $row['price'] }}' required     class='form-control ' />
										 </div>
										<label for="Price" class=" control-label col-md-2 text-left"> {{ Lang::get('core.price') }} <span class="asterix"> * </span></label>
										 <div class="col-md-3">
										 <input  type='text' name='price' id='price' value='{{ $row['price'] }}' required     class='form-control ' />
										 </div>
									  </div>
									  <div class="form-group  " >
										<label for="Currency" class=" control-label col-md-3 text-left"> {{ Lang::get('core.currency') }} <span class="asterix"> * </span></label>
										<div class="col-md-3">
									  ...
									  <div class="form-group  " >
										<label for="Description" class=" control-label col-md-3 text-left"> {{ Lang::get('core.description') }} <span class="asterix"> * </span></label>
										<div class="col-md-8">
