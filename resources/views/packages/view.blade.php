...
<div class="col-md-3">
    <div class="box box-primary">
        <div class="box-body box-profile">
            ...
            <p class="text-muted text-center">{{ \App\Library\SiteHelpers::TarihFormat($row->start)}} -
                {{ \App\Library\SiteHelpers::TarihFormat($row->end)}}</p>
        ...
        <div class="box-body">
                    ...
                    <div class="m-t-xl">
                        <h1 class="text-green">                            <?php
                            ...
                            <?php
                                ...
                                $invtotal += PackagesController::travelersDetail_unpaid($bl['travellers']);

                            ?>
                            @endforeach
                            {{number_format((float)$invtotal, 2)}} {{$currency}}</h1>
                    </div>
                </div>
            </div>
            </div>
            ...
            <div class="hpanel">
                    ...
                    <div class="m-t-xl">
                        <h1 class="text-red">                            <?php
                            ...
                            <?php
                                ...
                                $invtotal += PackagesController::travelersDetail_paid($bl['travellers']);
                ...
                <!-- <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="info-box">
                        <span class="info-box-icon" style="    background: unset;"><i class="fa fa-money" aria-hidden="true" style="    font-size: 1.5em; color: #6a6c6f;"></i>
                        </span>

                        <div class="info-box-content">
                            <span class="info-box-text">{{ Lang::get('core.cost_price') }}</span>
                            <span class="info-box-number">Later</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="info-box">
                        <span class="info-box-icon" style="    background: unset;"><i class="fa fa-random" aria-hidden="true" style="    font-size: 1.5em; color: #6a6c6f;"></i></span>
                        <div class="info-box-content">
                            <span class="info-box-text">{{ Lang::get('core.turnover') }}</span>
                            <span class="info-box-number">{{$turnover}}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="info-box">
                        <span class="info-box-icon" style="background: unset;">
                            <i class="fa fa-dollar" aria-hidden="true" style="font-size: 1.5em; color: #6a6c6f;"></i>

                        </span>
                        <div class="info-box-content">
                            <span class="info-box-text">{{ Lang::get('core.earning') }}</span>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="info-box">
                        <span class="info-box-icon" style="background: unset;"><i class="fa fa-credit-card" style="font-size: 1.5em; color: #6a6c6f;" aria-hidden="true"></i></span>
                        <div class="info-box-content">
                            <span class="info-box-text">{{ Lang::get('core.paid') }}</span>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="info-box">
                        <span class="info-box-icon" style="    background: unset;">
                            <i class="fa fa-sort-amount-asc" style="font-size: 1.5em; color: #6a6c6f;" aria-hidden="true"></i>
                        </span>
                        <div class="info-box-content">
                            <span class="info-box-text">{{ Lang::get('core.unpaid') }}</span>
                            <span class="info-box-number">
                            <?php
                ...
                <table class="table table-striped">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{!! PackagesController::travelersDetail($bl['travellers']) !!}
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th>
                                ...
                                <div class='col-md-1'>{{ Lang::get('core.atteched') }}</div>
                            </th>
                            <!-- <th><div class='col-md-6'>{{ Lang::get('core.namesurname') }}</div><div class='col-md-2'>{{ Lang::get('core.country') }}</div><div class='col-md-4'>{{ Lang::get('core.remarks') }}</div> </th> -->
                        </tr>
                        <?php $count = 1; ?>
