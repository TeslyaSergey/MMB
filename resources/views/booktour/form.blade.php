						...
						<fieldset><legend>{{Lang::get('core.booktour')}}</legend>
								...
								{!! Form::hidden('bookingID', app('request')->input('bookingID') ) !!}
										...
										<div class="" id="package_part" style="display:none;">
											...
											<div class="form-group  " >
											<label for="roomfeatureID" class=" control-label col-md-4 text-left">{{ Lang::get('core.roomtype') }}</label>
											<div class="col-md-4">
											...
											<div class="form-group  " >
											<label for="roomfeatureID" class=" control-label col-md-4 text-left">{{ Lang::get('core.flighttype') }}</label>
											<div class="col-md-4">
												<select name='roomfeatureID' rows='5' id='roomfeatureID' class='select2'>
												</select>
											 </div>
